<template>
  <div class="dashboard-container">
    ...
    <el-dialog title="分配权限" :visible="pershowdialog" @close="percanCel">
      <el-tree
        ref="permTree"
        :data="permData"
        :props="defaultProps"
        :default-expand-all="perboolen"
        :show-checkbox="true"
        :check-strictly="true"
        node-key="id"
      ...
      <el-row slot="footer" type="flex" justify="center">
        <el-col :span="6">
          <el-button size="small" @click="percanCel">取消</el-button>
          <el-button size="small" type="primary" @click="perbtnOk"
            >确定</el-button
          >
        </el-col>
      </el-row>
...
export default {
  ...
  methods: {
    ...
    async assignPerm(id) {
      this.permData = tranLisToTreeData(await getPermissionList(), "0")
      this.roleId = id
